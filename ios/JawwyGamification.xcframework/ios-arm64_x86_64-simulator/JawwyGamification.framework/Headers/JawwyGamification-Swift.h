...
#ifndef JAWWYGAMIFICATION_SWIFT_H
#define JAWWYGAMIFICATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="JawwyGamification",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17JawwyGamification15AnimatedControl")
...
SWIFT_CLASS("_TtC17JawwyGamification14AnimatedButton")
...
SWIFT_CLASS("_TtC17JawwyGamification14AnimatedSwitch")
...
SWIFT_CLASS("_TtC17JawwyGamification16AnimationSubview")
...
SWIFT_CLASS("_TtC17JawwyGamification10LottieView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC17JawwyGamification13AnimationView")
...
SWIFT_CLASS("_TtC17JawwyGamification19CompatibleAnimation")
...
SWIFT_CLASS("_TtC17JawwyGamification26CompatibleAnimationKeypath")
...
SWIFT_CLASS("_TtC17JawwyGamification23CompatibleAnimationView")
...
SWIFT_PROTOCOL("_TtP17JawwyGamification22CountdownTimerDelegate_")
...
SWIFT_CLASS("_TtC17JawwyGamification15IQBarButtonItem")
...
SWIFT_CLASS("_TtC17JawwyGamification28IQBarButtonItemConfiguration")
...
SWIFT_CLASS("_TtC17JawwyGamification12IQInvocation")
...
SWIFT_CLASS("_TtC17JawwyGamification17IQKeyboardManager")
...
@interface IQKeyboardManager (SWIFT_EXTENSION(JawwyGamification)) <UIGestureRecognizerDelegate>
...
@interface IQKeyboardManager (SWIFT_EXTENSION(JawwyGamification))
...
SWIFT_CLASS("_TtC17JawwyGamification26IQKeyboardReturnKeyHandler")
...
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(JawwyGamification)) <UITextFieldDelegate>
...
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(JawwyGamification)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC17JawwyGamification18IQPreviousNextView")
...
SWIFT_CLASS("_TtC17JawwyGamification10IQTextView")
...
SWIFT_CLASS("_TtC17JawwyGamification20IQTitleBarButtonItem")
...
SWIFT_CLASS("_TtC17JawwyGamification9IQToolbar")
...
SWIFT_CLASS("_TtC17JawwyGamification17SwiftFortuneWheel")
@interface SwiftFortuneWheel : UIControl
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
@interface SwiftFortuneWheel (SWIFT_EXTENSION(JawwyGamification))
/// Pin image name from assets catalog, sets image to the <code>pinImageView</code>
@property (nonatomic, copy) IBInspectable NSString * _Nullable pinImage;
/// is <code>pinImageView</code> hidden
@property (nonatomic) IBInspectable BOOL isPinHidden;
/// Spin button image name from assets catalog, sets image to the <code>spinButton</code>
@property (nonatomic, copy) IBInspectable NSString * _Nullable spinImage;
/// Spin button background image from assets catalog, sets background image to the <code>spinButton</code>
@property (nonatomic, copy) IBInspectable NSString * _Nullable spinBackgroundImage;
/// Spin button title text, sets title text to the <code>spinButton</code>
@property (nonatomic, copy) IBInspectable NSString * _Nullable spinTitle;
/// Is <code>spinButton</code> hidden
@property (nonatomic) IBInspectable BOOL isSpinHidden;
/// Is <code>spinButton</code> enabled
@property (nonatomic) IBInspectable BOOL isSpinEnabled;
@end
...
@interface UIImage (SWIFT_EXTENSION(JawwyGamification))
...
@interface UINavigationController (SWIFT_EXTENSION(JawwyGamification))
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
@end


@interface UIScrollView (SWIFT_EXTENSION(JawwyGamification))
...
@interface UIView (SWIFT_EXTENSION(JawwyGamification))
/// To set customized distance from keyboard for textField/textView. Can’t be less than zero
@property (nonatomic) CGFloat keyboardDistanceFromTextField;
...
@interface UIViewController (SWIFT_EXTENSION(JawwyGamification))
